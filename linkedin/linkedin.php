...
require_once $docroot."/linkedin/OAuth.php";
...
/////////////////////////////////////
  ...
  function setStatus($status) {
    ...
    $response = $this->httpRequestStatus($status_url, $auth_header, "PUT", $xml);
    return $response;
  }
   ////////////////////////////////////////////////////////////
    function httpRequestStatus($url, $auth_header, $method, $body = NULL) {
    if (!$method) {
      $method = "GET";
    };
